...
const Home = async ({ params }: LocaleParamProps) => {
  ...
  return (
    <div className="bg-left min-h-screen logoBackground flex justify-end">
      <h1 className="text-3xl font-bold text-black mt-10 text-center">
        Welcome to our Vivid-Panda app. Here you can play with your photo!
      </h1>
      {/* <h1 className="text-3xl font-bold text-black mt-10 text-center">Here you can play with your photo!</h1> */}
      <div
        ...
        <div className="flex justify-center items-center w-full mt-10">
          <form className={`${cardClassName} p-5 gap-5 shadow-2xl flex flex-col items-center w-full`}>
            ...
            <Link href="/auth/login">
              <button className="mt-5 text-black text-lg font-bold w-full h-64 rounded-lg hover:opacity-80 transition duration-200 btn-success px-10 py-4">
                {t('welcome_header')}
              </button>
            </Link>
          </form>
