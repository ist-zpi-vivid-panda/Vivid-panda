...
class TestFeaturesProcessorSaturation(unittest.TestCase):
    ...
    def test_black_image_saturation(self) -> None:
        saturation = self.processor_black.saturation
        self.assertEqual(saturation, 0)

    def test_white_image_saturation(self) -> None:
        saturation = self.processor_white.saturation
        self.assertEqual(saturation, 0)

    def test_black_white_image_saturation(self) -> None:
    ...
    def test_cache_functionality(self) -> None:
        with patch.object(
            ...
            wraps=self.processor_black.calculate_saturation,
        ) as mocked:
...
class TestFeaturesProcessorSaturationWithRealImages(unittest.TestCase):
    def setUp(self) -> None:
        self.image_folder = Path(
            "../../test_resources/features_processor/saturation_examples"
        )
    ...
    def test_real_image_1_saturation(self) -> None:
    ...
    def test_real_image_2_saturation(self) -> None:
    ...
    def test_real_image_3_saturation(self) -> None:
