...
class TestFeaturesProcessorBrightness(unittest.TestCase):
    ...
    def test_black_white_image_brightness(self):
        brightness = self.processor_black_white.brightness
        self.assertEqual(brightness, 127.5)

    def test_cache_functionality(self):
        with patch.object(self.processor_black, 'calculate_brightness', wraps=self.processor_black.calculate_brightness) as mocked:
...
class TestFeaturesProcessorBrightnessWithRealImages(unittest.TestCase):
    def setUp(self):
        self.image_folder = Path("../../test_resources/features_processor/brightness_examples")
    ...
    def test_real_image_1_brightness(self):
    ...
    def test_real_image_2_brightness(self):
    ...
    def test_real_image_3_brightness(self):
