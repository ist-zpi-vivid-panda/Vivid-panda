...
class TestFeaturesProcessorWhiteBalanceScore(unittest.TestCase):
    ...
    def test_cache_functionality(self) -> None:
        with patch.object(
            ...
            wraps=self.processor_black.calculate_white_balance,
        ) as mocked:
...
class TestFeaturesProcessorWhiteBalanceScoreWithRealImages(unittest.TestCase):
    def setUp(self) -> None:
        self.image_folder = Path(
            "../../test_resources/features_processor/white_balance_examples"
        )
    ...
    def test_real_image_1_white_balance_score(self) -> None:
    ...
    def test_real_image_2_white_balance_score(self) -> None:
    ...
    def test_real_image_3_white_balance_score(self) -> None:
