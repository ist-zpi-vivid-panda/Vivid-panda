...
class TestFeaturesProcessorContrast(unittest.TestCase):
    ...
    def test_black_image_contrast(self):
        contrast = self.processor_black.contrast
        self.assertEqual(contrast, 0)

    def test_white_image_contrast(self):
        contrast = self.processor_white.contrast
        self.assertEqual(contrast, 0)

    def test_black_white_image_contrast(self):
        contrast = self.processor_black_white.contrast
        self.assertEqual(contrast, 127.5)

    def test_cache_functionality(self):
        with patch.object(self.processor_black, 'calculate_contrast', wraps=self.processor_black.calculate_contrast) as mocked:
...
class TestFeaturesProcessorContrastWithRealImages(unittest.TestCase):
    def setUp(self):
        self.image_folder = Path("../../test_resources/features_processor/contrast_examples")
    ...
    def test_real_image_1_contrast(self):
